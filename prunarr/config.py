...
class Settings(BaseModel):
    ...
    @field_validator("radarr_api_key", "radarr_url", "sonarr_api_key", "sonarr_url", "tautulli_api_key", "tautulli_url")
    @classmethod
...
def load_settings(config_file: Optional[str] = None) -> Settings:
    ...
    return Settings(
        ...
        user_tag_regex=config_data.get("user_tag_regex") or os.getenv("USER_TAG_REGEX", r"^\d+ - (.+)$"),
    )
